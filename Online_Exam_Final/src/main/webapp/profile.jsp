...
User user=pDAO.getUserDetails(session.getAttribute("userId").toString());
        ...
        %>
         <!-- SIDEBAR -->
           ...
           <div class="profile ">
               <h2><span class="tag">Your Name</span>
               <span class="val"><%=user.getFirstName()+" " %> <%=user.getLastName() %></span><br/>
               ...
               %><br/><a href="adm-page.jsp?pgprt=0&pedt=1"><span class="add-btn">Edit Profile</span></a>
